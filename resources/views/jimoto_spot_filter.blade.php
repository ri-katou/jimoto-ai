                            ...
                            @foreach ($meisyo as $item)
                                <label>
                                    <li><input type="checkbox" value="{{ $item->id }}"
                                            name="categoryCheck[]">{{ $item->category_name }}</li>
                                </label>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="spot-filter-content-aria" id="aria">
                ...
                <div class="spot-filter-content-aria-title-container">
                    <div class="spot-filter-content-aria-title-item">
                        <label>
                            <div class="underline-pink check"><input class="select-item-center" type="checkbox"
                                    id="center" value="県央" name="area-check[]">県央</div>
                        </label>
                        <ul>
                            @foreach ($center as $item)
                                <label>
                                    <li><input type="checkbox" value="{{ $item->id }}"
                                            name="municipalitieCheck[]">{{ $item->municipalities_name }}</li>
                                </label>
                            @endforeach
                        </ul>
                    </div>
                    <div class="spot-filter-content-aria-title-item">
                        <label>
                            <div class="underline-blue check"><input type="checkbox" id="west" value="西部"
                                    name="area-check[]">西部</div>
                        </label>
                        <ul>
                            @foreach ($west as $item)
                                <label>
                                    <li><input class="select-item-west" type="checkbox" value="{{ $item->id }}"
                                            name="municipalitieCheck[]">{{ $item->municipalities_name }}</li>
                                </label>
                            @endforeach
                        </ul>
                    ...
                    <div class="spot-filter-content-aria-title-item">
                        <label>
                            <div class="underline-orange check"><input class="select-item-east" type="checkbox"
                                    id="east" value="東部" name="area-check[]">東部
                            </div>
                        </label>
                        <ul>
                    ...
                    <div class="spot-filter-content-aria-title-item">
                        <label>
                            <div class="underline-green check"><input class="select-item-agatuma" type="checkbox"
                                    id="agatuma" value="吾妻" name="area-check[]">吾妻</div>
                        </label>
                        <ul>
                    ...
                    <div class="spot-filter-content-aria-title-item">
                        <label>
                            <div class="underline-purple check"><input class="select-item-tonenumata" type="checkbox"
                                    id="tonenumata" value="利根・沼田" name="area-check[]">利根・沼田</div>
                        </label>
                        <ul>
