...
<div class="post-all-list">
    <div class="post-list-header">
        <div class="list-head hidden-head">
            <a href="{{route('home.post.check')}}">
                <div class="post-syoukaijou-head">
                    <div class="post-head-font"><img src="/image/mail8.svg" alt="free-svg" class="free-svg post-list-head-img-rgba">投稿した紹介状</div>
        ...
        <div class="list-head hidden-head">
            <a href="{{route('home.interest.check')}}">
                <div class="post-syoukaijou-head">
                    <div class="post-head-font"><img src="/image/hart2.svg" alt="free-svg" class="free-svg post-list-head-img-rgba">行ってみたい</div>

                </div>
            </a>
        </div>
        <div class="list-head list-head-back center-head">
            <a href="{{route('home.visit.check')}}">
                <div class="post-syoukaijou-head">
                    <div class="post-head-font"><img src="/image/goal.svg" alt="free-svg" class="free-svg"><span class="post-underline-green">行ったよ</span></div>
                </div>
            </a>
        </div>
    </div>
