        ...
        <div class="spot-filter-content-genre" id="genre">
            ...
            <div class="spot-filter-content-genre-title-container">
                <div class="spot-filter-content-genre-title-item">
                    <div class="underline-orange"> <input type="checkbox" id="meisyo">名所</div>
                    <ul>
                        @foreach ($meisyo as $item)
                        <li><input type="checkbox" value="{{ $item->category_name }}" name="{{ $item->category_name }}">{{ $item->category_name }}</li>
                        @endforeach
                    </ul>
                </div>
                <div class="spot-filter-content-genre-title-item">
        ...
        <div class="spot-filter-content-aria" id="aria">
            ...
            <div class="spot-filter-content-aria-title-container">
                <div class="spot-filter-content-aria-title-item">
                    <div class="underline-pink"><input type="checkbox" id="center" class="aria-check area_id_{{$item->area_id}}">県央</div>
                    <ul>
                        @foreach ($center as $item)
                        <li><input type="checkbox" value="{{ $item->municipalities_name }}" name="{{ $item->municipalities_name }}" class="area_id_{{$item->area_id}}">{{ $item->municipalities_name }}</li>
                        @endforeach
                    </ul>
                </div>
                <div class="spot-filter-content-aria-title-item">
                    ...
                    <ul>
                        ...
                        <li><input type="checkbox" value="{{ $item->municipalities_name }}" name="{{ $item->municipalities_name }}">{{ $item->municipalities_name }}</li>
                        @endforeach
                    </ul>
                </div>
                <div class="spot-filter-content-aria-title-item">
                    <div class="underline-orange"><input type="checkbox" id="east">東部</div>
                    <ul>
                ...
                <div class="spot-filter-content-aria-title-item">
                    <div class="underline-green"><input type="checkbox" id="agatuma">吾妻</div>
                    <ul>
                ...
                <div class="spot-filter-content-aria-title-item">
                    <div class="underline-purple"><input type="checkbox" id="tonenumata">利根・沼田</div>
                    <ul>
