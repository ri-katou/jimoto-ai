        ...
        <div class="syoukaijou-all">
            <div class="syoukaijyou-hyouji">
                ...
                <div class="card-margin">
                    ...
                    <div class="syoukaijou-card">
                                        ...
                                        <div class="preview-honbun">
                                            ...
                                            <div class="fav_btn" id="{{ $item->syoukaijous_id }}" data-me="{{ Auth::id() }}">
                                                <div class="fav_btn-interest">
                                                    <i class="fav_btn-interest-icon fas fa-heart 
                        ...
                        "></i>
                                                ...
                                                <div class="fav-btn-visited">
                                                    <i class="fav_btn-visited-icon fas fa-flag 
                    ...
                    {{-- ここまで紹介状１枚 --}}
                    @else
                    <div class="dummy">地元のおすすめスポットを紹介してみよう！<br><br><div class="dammy-link"><a href="{{ route('syoukaijou.create') }}">紹介状作成</a>はこちら</div>
                    </div>
                    @endif
                </div>
