        ...
        <div class="syoukaijou-header">
            <div class="home-icon-right">
                <div class="profile-icon">
                    <img src="{{ isset(\App\User_detail::select('icon_image')->where('user_id', Auth::id())->first()->icon_image)? \App\User_detail::select('icon_image')->where('user_id', Auth::id())->first()->icon_image: 'https://jimotoai2023.s3.ap-northeast-1.amazonaws.com/jimotoaiprofile/cgj35n6IhyLz3mbaMJ3kt0EfsRtP1yuIJhDDJ9XP.jpg' }}"
                        alt="myimage" class="profile-icon-img">
                </div>
                        ...
                        @if (count($post) >= 1)
                                ...
                                @foreach ($post as $item)
                                    <div class="syou">
                                        <div class="syoukaijou-sam">
                                            <a class="syoukaijou-link"
                                                href="{{ route('syoukaijou.disp', ['id' => $item->syoukaijous_id]) }}">
                                            ...
                                            <div class="fav_btn" id="{{ $item->syoukaijous_id }}"
                                                ...
                                                <div class="fav_btn-interest">
                                                    <i onclick="interest(this)" data-id="{{ $item->syoukaijous_id }}"
                                                        data-me="{{ Auth::id() }}"
                            ...
                            @endif @endforeach"></i>
                                                ...
                                                <div class="fav-btn-visited">
                                                    <i onclick="visited(this)" data-id="{{ $item->syoukaijous_id }}"
                                                        data-me="{{ Auth::id() }}"
