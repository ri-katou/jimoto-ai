...
@section('content')
    ...
    <div class="preview-main-sam">
        <div class="preview-pics-sam">
            <div class="preview-pic1-sam"><img id="gazo" src="{{ asset($item->image1) }}" width="100%" height="100%"
                    border="0" alt=""></div>
        ...
        <div class="preview-honbun">
            ...
            <div class="fav_btn">
                <div class="fav_btn-ittemitai">
                    <i class="fa-ittemitai" aria-hidden="true"><svg version="1.1" id="_x32_"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            width="512px" height="512px" viewBox="0 0 512 512"
                            style="width: 40px; height: 40px; opacity: 1;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill: #4B4B4B;
                                }
      ...
      l217.969,217.984l218-217.984C524.672,207.123,524.672,124.936,473.984,74.248z" style="fill: rgb(255, 175, 223);">
                                </path>
                            </g>
                        </svg>
                    </i>
                            ...
                            <div class="syoukaijou-sam">
                                <div class="preview-syoukaijou-top-sam">
                                    ...
                                    <div class="janru-area-sam">
                                        <div class="janru-tag">
                                            <div class="jyanru-sub">{{ $syoukaijou->category_id }}</div>
                                        </div>
                                        <div class="area-tag">
                                            <div class="area-sub">{{ $syoukaijou->municipalities_id }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="preview-main-sam">
                                    <div class="preview-pics-sam">
                                        <div class="preview-pic1-sam"><img id="gazo"
                                                src="{{ asset($syoukaijou->image1) }}" width="100%" height="100%"
                                                border="0" alt=""></div>
                                        <div class="preview-pics-sub">
                                            <div class="preview-pic2-sam"></div>
                                            <div class="preview-pic3-sam"></div>
                                    ...
                                    <div class="preview-honbun">
                                        ...
                                        <div class="fav_btn">
                                            <div class="fav_btn-ittemitai">
                                                <i class="fa-ittemitai" aria-hidden="true"><svg version="1.1"
          ...
          l217.969,217.984l218-217.984C524.672,207.123,524.672,124.936,473.984,74.248z" style="fill: rgb(255, 175, 223);">
                                            ...
                                            <div class="fav-btn-ittayo">
                                                <i class="fa-ittayo" aria-hidden="true"><svg version="1.1"
                                                        id="_x32_" xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                        viewBox="0 0 512 512"
                                                        style="width: 40px; height: 40px; opacity: 1;"
      ...
      211.134,165.33 	"
                                                                style="fill: rgb(192, 192, 192);"></polygon>
                                                        </g>
                                                    </svg></i>
