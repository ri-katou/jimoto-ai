...
@section('content')
    ...
    <div class="jimoto-sam">
                ...
                <div class="syoukaijou-sam">
                    ...
                    <div class="preview-main-sam">
                        <div class="preview-pics-sam">
                            <div class="preview-pic1-sam"><img id="gazo" src="{{ asset($syoukaijou->image1) }}"
                            ...
                            <div class="fav_btn">
                                <div class="fav_btn-ittemitai">
                                    <i class="fa-ittemitai" aria-hidden="true"><svg version="1.1" id="_x32_"
                                            ...
                                            viewBox="0 0 512 512" style="width: 40px; height: 40px; opacity: 1;"
                                            xml:space="preserve">
                                            <style type="text/css">
                                                .st0 {
                                                    fill: #4B4B4B;
      ...
      l217.969,217.984l218-217.984C524.672,207.123,524.672,124.936,473.984,74.248z"
                                                    style="fill: rgb(255, 175, 223);"></path>
                                            </g>
                                        </svg>
                                    </i>
                                ...
                                <div class="fav-btn-ittayo">
                                    <i class="fa-ittayo" aria-hidden="true"><svg version="1.1" id="_x32_"
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
